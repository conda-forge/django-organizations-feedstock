...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-organizations-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9866&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-organizations-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-organizations` can be installed with:

```
conda install django-organizations
```

It is possible to list all of the versions of `django-organizations` available on your platform with:
